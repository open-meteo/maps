...
<SheetPortal {...portalProps}>
	...
	>
		...
		<SheetPrimitive.Close
			class="ring-offset-background cursor-pointer focus-visible:ring-ring absolute end-4 top-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden disabled:pointer-events-none"
		>
			<XIcon class="size-4" />
