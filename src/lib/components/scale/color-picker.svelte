...
<div
	class="color-picker-content absolute left-full bottom-20 ml-2 z-50 bg-glass/90 backdrop-blur shadow-md border border-border rounded-lg shadow-xl p-3 w-60"
